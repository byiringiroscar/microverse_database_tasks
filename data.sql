...
values(1, (SELECT id FROM species where name='Pokemon'));

INSERT INTO specializations (vet_id, species_id)
VALUES (2, (SELECT id FROM species WHERE name = 'Digimon'));

INSERT INTO specializations (vet_id, species_id)
VALUES (2, (SELECT id FROM species WHERE name = 'Pokemon'));

INSERT INTO specializations (vet_id, species_id)
VALUES (3, (SELECT id FROM species WHERE name = 'Digimon'));
